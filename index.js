...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function setupEditorToolbar() {
        ...
        const aiClinicalBtn = createButton('Importancia clínica', '🩺', null, null, generateClinicalImportance);
        editorToolbar.appendChild(aiClinicalBtn);
        editorToolbar.appendChild(createSeparator());
    ...
    async function generateClinicalImportance() {
        ...
        try {
            ...
            showAlert('Error al contactar a la IA: ' + error.message);
        }
    }
