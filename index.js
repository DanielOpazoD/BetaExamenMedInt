...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let toolbarIconDropdown, toolbarCharDropdown;
    ...
    function renderIconManager() {
        ...
        icons.forEach((icon, index) => {
            ...
            delBtn.addEventListener('click', (e) => {
                ...
                if (toolbarIconDropdown) toolbarIconDropdown.refreshSymbols();
            });
    ...
    function renderCharManager() {
        ...
        globalSpecialChars.forEach((char, index) => {
            ...
            delBtn.addEventListener('click', (e) => {
                ...
                renderCharManager();
                if (toolbarCharDropdown) toolbarCharDropdown.refreshSymbols();
            });
            wrapper.appendChild(delBtn);
    ...
    function setupEditorToolbar() {
        ...
        const createSymbolDropdown = (symbols, title, icon, onEdit) => {
            ...
            if (onEdit) {
                ...
                editBtn.className = 'px-2 py-1 text-xs rounded hover:bg-gray-200 dark:hover:bg-gray-700';
            ...
            renderSymbols();
            dropdown.refreshSymbols = renderSymbols;
            dropdown.appendChild(content);
            btn.addEventListener('click', (e) => {
                e.preventDefault();
                e.stopPropagation();
        ...
        // Symbols
        toolbarIconDropdown = createSymbolDropdown(
            EMOJI_CATEGORIES['Sugeridos'],
            'Insertar Símbolo',
            '📌',
            () => {
                EMOJI_CATEGORIES['Sugeridos'] = defaultSuggestedIcons.concat(customIconsList);
        ...
        editorToolbar.appendChild(toolbarIconDropdown);

        toolbarCharDropdown = createSymbolDropdown(
            globalSpecialChars,
        ...
        editorToolbar.appendChild(toolbarCharDropdown);
    }
    ...
    function populateIconPicker() {
        ...
        editButton.id = 'open-icon-manager-btn';
        editButton.textContent = 'Editar';
        editButton.className = 'ml-auto px-2 py-1 text-sm rounded hover:bg-gray-200 dark:hover:bg-gray-700';
        editButton.addEventListener('click', () => {
            EMOJI_CATEGORIES['Sugeridos'] = defaultSuggestedIcons.concat(customIconsList);
            renderIconManager();
            showModal(iconManagerModal);
        });
        editButton.addEventListener('dblclick', (e) => {
            e.preventDefault();
            renderCharManager();
            showModal(charManagerModal);
        });
        iconPickerCategories.appendChild(editButton);
